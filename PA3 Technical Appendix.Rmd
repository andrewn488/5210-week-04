...
# Purpose: Participation Assignment 3 Technical Appendix
# Date: July 15th, 2021
# Author: 
...
conditionbyyear <- houses %>%
  ...
  # condition 2 label
  geom_text(data = data.frame(x = 2002.70063698153, y = 944000.543861757, label = "Condition 2"),
  mapping = aes(x = x, y = y, label = label),
...
ConditionVsGrade <- houses %>% 
  ...
  labs(x = "Grade of Home",
       ...
       title = "Condition 2 homes are the most common homes \nin Good and Better grade categories", 
       subtitle = "Labels indicate condition rating of home") + 
